import type { ComparableListing, ValuationInput, ValuationResult } from './types';
...
// Future live searches must run through a secure backend. Never expose marketplace API keys in a web or mobile client.
